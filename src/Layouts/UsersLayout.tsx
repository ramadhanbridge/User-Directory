  ...
  return (
    <div className="flex min-h-screen bg-zinc-50">
      <aside className="sticky top-0 z-20 hidden h-screen w-24 shrink-0 overflow-hidden md:flex lg:w-28">
        <div className="relative flex h-full w-full flex-col items-center justify-between bg-linear-to-b from-[#1a3f6b] via-[#3b6dae] to-[#152d4d] px-3 py-10">
          ...
          <div className="relative h-16 w-px bg-linear-to-b from-transparent via-white/60 to-transparent" />
          ...
          <div className="relative flex flex-col items-center gap-3">
            ...
            <div className="h-16 w-px bg-linear-to-b from-transparent via-white/60 to-transparent" />
          </div>
        </div>
      </aside>
